...
def test_operation_creation():
    ...
    operation = Operation(type=OperationType.FAILOVER, target_node="node1", parameters={"force": True}, timing=timing)
...
def test_chaos_config_creation():
    ...
    chaos_config = ChaosConfig(
        chaos_type=ChaosType.PROCESS_KILL, target_selection=target_selection, timing=timing, coordination=coordination
    )
...
def test_scenario_creation():
    ...
    # Create operation
    operation = Operation(type=OperationType.FAILOVER, target_node="node1", parameters={}, timing=OperationTiming())
