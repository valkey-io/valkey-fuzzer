...
def test_create_cluster_success(mock_cluster_manager_class, mock_config_manager_class):
    ...
    config = ClusterConfig(num_shards=1, replicas_per_shard=0, base_port=7000)
...
def test_create_cluster_cleanup_on_formation_failure(mock_cluster_manager_class, mock_config_manager_class):
    ...
    config = ClusterConfig(num_shards=1, replicas_per_shard=1, base_port=7000)
...
def test_get_node_info_success():
    ...
    coordinator.active_clusters["test-cluster"] = {"instance": cluster_instance, "config_manager": Mock()}
