...
class ErrorHandler:
        ...
        for attempt in range(config.max_attempts):
            try:
                ...
                if attempt < config.max_attempts - 1:
                    ...
                    backoff_delay = min(delay * (config.exponential_base**attempt), config.max_delay)
    ...
    def cleanup_after_failure(
        self, cluster_instance=None, cluster_connection=None, chaos_coordinator=None, cluster_coordinator=None
    ) -> bool:
    ...
    def get_error_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "recent_errors": [
                {"category": e.category.value, "severity": e.severity.value, "message": e.message}
